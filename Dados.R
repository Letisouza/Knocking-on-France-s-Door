...
residence <- read_csv("C:/Users/letic/Desktop/Pesquisas/PIBIC - artigo 2021/eurostat/Novos/2021/migr_resvalid_residence_all valid_.csv")

#migr_asydcfcta - First instance decisions on applications by citizenship, age and sex - annual 
asilo <- read_csv("C:/Users/letic/Desktop/Pesquisas/PIBIC - artigo 2021/eurostat/Novos/2021/migr_asydcfsta_asilo.csv")

#migr_asyresa - Resettled persons by age, sex and citizenship - annual data (rounded)
resettled <- read_csv("C:/Users/letic/Desktop/Pesquisas/PIBIC - artigo 2021/eurostat/Novos/2021/migr_asyresa_resettled.csv")
